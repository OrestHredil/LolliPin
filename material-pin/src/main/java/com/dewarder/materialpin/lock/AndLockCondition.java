...
final class AndLockCondition implements LockCondition {

    private final LockCondition left;
    private final LockCondition right;

    private AndLockCondition(LockCondition left, LockCondition right) {
        this.left = left;
        this.right = right;
    }
    ...
    static LockCondition create(@NonNull LockCondition left, @NonNull LockCondition right) {
        ...
        return new AndLockCondition(left, right);
    }
